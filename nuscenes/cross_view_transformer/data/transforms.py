...
class Sample(dict):
    def __init__(
        ...
        **kwargs
        ...
        self.object_distribution_var = object_distribution_var
...
class SaveDataTransform:
    ...
    def get_bev(self, batch: Sample):
        ...
        if batch.object_distribution_var is not None:  # object_distribution_var가 존재하면 저장
            result['object_distribution_var'] = batch.object_distribution_var
...
class LoadDataTransform(torchvision.transforms.ToTensor):
    ...
    def get_bev(self, sample: Sample):
        ...
        # Load object_distribution_var
        if 'object_distribution_var' in sample:
            result['object_distribution_var'] = sample['object_distribution_var']  # object_distribution_var 로드
